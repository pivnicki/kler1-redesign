...
<script src="http://maps.google.com/maps/api/js?key=AIzaSyDEZ5RlhXnEkXC3G34ZTb_lOVjVOXQuFkA&callback=initMap"
 ...
 <p class="text-center text-uppercase  fw-800">
 <a href="http://localhost/wordpress_kler/privrednici-srbobran/">
 Privrednici Srbobran</a>
 </p>
 </div>
  <div class="col-sm-4">
   <p class="text-center">
 ...
 <p class="text-center text-uppercase fw-800">
		...
		<a href="http://localhost/wordpress_kler/preduzetnici-srbobran/">
 ...
 <p class="text-center  text-uppercase fw-800">
	<a href=" http://localhost/wordpress_kler/udruzenje-srbobran/">
		Udruzenja Srbobran
		</a>
 </p>
 </div>
...
markers1 = [
	...
	['11', 'AUTO STEFAN CENTAR PROIZVODNO USLUŽNO I PROMETNO EXPORT IMPORT DRUŠTVO SA OGRANIČNOM ODGOVORNOŠĆU, SRBOBRAN, Vuka Karadߩ硠2', 45.546428, 19.792379, 'privrednici','http://www.kler-srbobran.rs/auto-stefan-centar-proizvodno-usluzno-i-prometno-export-import-drustvo-sa-ogranicenom-odgovornoscu-srbobran/','http://maps.google.com/mapfiles/ms/icons/blue-dot.png'],
